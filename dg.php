   ...
   <center>  
    ...
    <table width="650">
        <tbody><tr>
            <td style="text-align: left">
                    ...
                    The <strong>Department of Geography</strong> was established in the year 1955 and P.G. classes were started in the year 1979. The intake of the department for 
                        <strong>U.G classes is 180</strong> and for <strong>P.G classes is 30</strong>. At present, 
                        <strong>Head of the department is Dr. Udaybhanu Singh</strong>.
                        <br>
	...
	<table cellspacing="8" cellpadding="4" rules="all" border="1" id="ContentPlaceHolder1_GridView1" style="color:Maroon;font-family:Verdana;font-size:Small;font-weight:bold;height:219px;width:650px;">
		<tbody><tr style="color:White;background-color:#5D7B9D;font-weight:bold;">
			...
			<td><a href="fac10.php">Dr.Vandana Tyagi</a></td><td>Associate Professor &amp; Head</td><td>M.A.,  Ph.D</td>
