...
<table id="ContentPlaceHolder1_DataList1" cellspacing="0" style="color:Maroon;font-size:Medium;border-collapse:collapse;">
	<tr>
        ...
        <td valign="top" width="25%">
            <img id="ContentPlaceHolder1_DataList1_Img11_0" src="img/office/StaffImage/p2.jpg" style="border-width:1px;border-style:solid; width: 100%;" />
        ...
        <table border="0" width="100%">
                ...
                <tr>
                 ...
                 <tr>
                    ...
                    <td></td>
                    <td><br /> 1/7/1958 <br /> </td>
                 </tr>
                 <tr>
                    <td>
                    <br />Date of Joining: <br /></td>
                    <td></td>
                    <td><br />2/4/1989 <br /></td>
                 </tr>
                 <tr>
                    <td>
                   ...
                   <tr>
                    ...
                    <td></td>
                    <td><br />M.Com., M.A.(Eco.), Ph.D <br /></td>
                </tr>
                <tr>
                    <td> <br />Address:
                    <br /></td>
                 ...
                 <tr>
                    ...
                    <td></td>
                    <td><br /> 9457272749 <br /></td>
                 </tr>
                 <tr>
                    <td>
                    <br />E-Mail: <br /></td>
                    <td></td>
                    <td><br />nishaagarwal58@gmail.com <br /></td>
                 </tr>
                 <tr>
                    <td>
                    <br />Specilization:  <br /></td>
                    <td></td>
                    <td> <br />Management <br /> </td>
                   </tr>
                    <tr>
                    <td>
                    <br />Interest: <br /></td>
                    <td></td>
                    <td><br /> Management , Accounting & Social Service </td>
                   </tr>
                </tr>
        </table>
