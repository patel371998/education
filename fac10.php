...
<table id="ContentPlaceHolder1_DataList1" cellspacing="0" style="color:Maroon;font-size:Medium;border-collapse:collapse;">
    <tr>
        ...
        <td valign="top" width="25%">
            <img id="ContentPlaceHolder1_DataList1_Img11_0" src="" style="border-width:1px;border-style:solid; width: 100%;" />
        ...
        <table border="0" width="100%">
               ...
               <td>Dr.Vandana Tyagi <br /></td>
                ...
                <tr>
                    ...
                    <br /></td>
                    <td></td>
                    <td><br />Associate Professor & Head
                    <br /></td>
                 </tr>
                 <tr>
